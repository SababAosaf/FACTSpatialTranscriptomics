...
import random
import numpy as np
from IST_model import Encoder, Encoder_sparse, Encoder_map, Encoder_sc
...
class GraphST():
    ...
    def train(self):
        ...
        #     self.hiden_feat, self.emb,k,j= self.model(self.features, self.features_a, self.adj)
        #
        #
        ...
        #            # print((self.emb_rec.shape))
        #            # self.emb_rec = self.model(self.features, self.features_a, self.adj)[3].detach().cpu().numpy()
        #            # print(self.emb_rec)
        # print("H55")
        # self.emb_rec = self.model(self.features, self.features_a, self.adj)[3].detach().cpu().numpy()
        # print(self.emb_rec)
