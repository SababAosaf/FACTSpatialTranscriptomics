...
class Encoder(Module):
    ...
    def forward(self, feat, feat_a, adj):
        ...
        k=feat
        # Encode to lower dimention
        z = torch.mm(z, self.weight1)

        # Cell and gene (lower dimention genes) become Cell and It and neighbour (lower dimention genes)

        #z = torch.mm(adj, z)

        hiden_emb = z

        # decode to higher dimention
        ...
        return hiden_emb, h,k, feat #, ret, ret_a
