...
def mclust_training(features, num_cluster, modelNames='EEE', random_seed=2020):
    """\
...
def clustering(adata, n_clusters=15, radius=50, key='emb', method='mclust', start=0.1, end=3.0, increment=0.01, refinement=False):
    """\
    ...
    # print(adata.obsm['emb'].copy())
    # print(adata.obsm['emb'].copy().shape)
    # print("<>")
    # print(embedding)
    # print(embedding.shape)
