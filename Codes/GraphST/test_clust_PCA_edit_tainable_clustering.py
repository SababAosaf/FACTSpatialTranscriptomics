...
typess=' - ,ARI,nmi,hom,cm,ch preaos,pas,aws,time,space,moranI,gearyC\n'
...
for i in files:
    ...
    #####_________________________ NEIGHBOUR INFO ____________________________-
    ...
    #####____________________________ IMAGE EMBEDDING ____________________________________
    ...
    #####_____________________ NEIGHBOUR INFO ___________________________
    ...
    model = autoencoder_clustering_trainable_clustering.GraphST(adata, device=device)
