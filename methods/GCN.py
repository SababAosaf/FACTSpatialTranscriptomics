...
from GCN_preprocess import preprocess_adj, preprocess_adj_sparse, preprocess, construct_interaction, construct_interaction_KNN, add_contrastive_label, get_feature, permutation, fix_seed
import time
import random
import numpy as np
from GCN_model import Encoder, Encoder_sparse, Encoder_map, Encoder_sc
...
class GraphST():
    ...
    def train(self):
        ...
        for epoch in tqdm(range(self.epochs)): 
            ...
            self.hiden_feat, self.emb = self.model(self.features, self.features_a, self.adj)
